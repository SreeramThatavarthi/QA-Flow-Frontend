...
export default function MiniQuestionCard({ id, tags, title, body, getUserQuestions, postedOn }) {
  ...
  return (
    <>
      <Card className={classes.root} variant="outlined" style={{ backgroundColor: "#bbdefb",marginBottom:"2px" }}>
        <CardContent>
